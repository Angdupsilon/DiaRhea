...
export const ScribbleCube: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M50 60L100 30L150 60L150 120L100 150L50 120L50 60Z" stroke={color} strokeWidth="8" strokeLinejoin="round"/>
    <path d="M50 60L100 90L150 60" stroke={color} strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M100 90V150" stroke={color} strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const ScribbleWind: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M40 60H120C140 60 150 40 130 30C110 20 100 50 120 70" stroke={color} strokeWidth="8" strokeLinecap="round"/>
    <path d="M20 100H150C170 100 180 80 160 70C140 60 130 90 150 110" stroke={color} strokeWidth="8" strokeLinecap="round"/>
    <path d="M50 140H100C120 140 130 160 110 170" stroke={color} strokeWidth="8" strokeLinecap="round"/>
  </svg>
);

export const ScribbleGlitch: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M40 40H160V160H40V40Z" stroke={color} strokeWidth="6" strokeLinecap="round"/>
    <path d="M30 60H170" stroke={color} strokeWidth="4" strokeDasharray="10 10"/>
    <path d="M30 100H170" stroke={color} strokeWidth="4" strokeDasharray="20 5"/>
    <path d="M30 140H170" stroke={color} strokeWidth="4" strokeDasharray="5 15"/>
    <path d="M60 60V140" stroke={color} strokeWidth="4"/>
    <path d="M120 40V120" stroke={color} strokeWidth="4"/>
  </svg>
);

export const ScribbleSpiral: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M100 100C100 100 110 100 110 90C110 80 100 80 90 80C70 80 70 100 70 110C70 130 90 140 110 140C140 140 150 110 150 90C150 50 110 40 90 40C50 40 30 80 30 120" stroke={color} strokeWidth="8" strokeLinecap="round"/>
  </svg>
);

export const ScribbleShield: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M40 40L100 20L160 40V90C160 140 100 180 100 180C100 180 40 140 40 90V40Z" stroke={color} strokeWidth="8" strokeLinejoin="round"/>
    <path d="M100 50V140" stroke={color} strokeWidth="6" strokeLinecap="round"/>
    <path d="M70 80H130" stroke={color} strokeWidth="6" strokeLinecap="round"/>
  </svg>
);

export const ScribbleDrop: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M100 40C100 40 40 110 40 140C40 170 70 190 100 190C130 190 160 170 160 140C160 110 100 40 100 40Z" stroke={color} strokeWidth="8" strokeLinejoin="round"/>
    <path d="M70 130C70 130 80 150 100 150" stroke={color} strokeWidth="6" strokeLinecap="round"/>
  </svg>
);

export const ScribbleBoom: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <circle cx="100" cy="100" r="40" stroke={color} strokeWidth="8"/>
    <path d="M100 40V20M100 160V180M40 100H20M160 100H180M60 60L40 40M140 140L160 160M60 140L40 160M140 60L160 40" stroke={color} strokeWidth="8" strokeLinecap="round"/>
  </svg>
);

export const ScribbleBox: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <rect x="50" y="50" width="100" height="100" stroke={color} strokeWidth="8" strokeLinejoin="round"/>
    <path d="M50 50L150 150M150 50L50 150" stroke={color} strokeWidth="6"/>
  </svg>
);

export const ScribbleTriangle: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M100 30L170 160H30L100 30Z" stroke={color} strokeWidth="8" strokeLinejoin="round"/>
    <circle cx="100" cy="110" r="20" stroke={color} strokeWidth="6"/>
  </svg>
);

export const ScribbleLoop: React.FC<ScribbleProps> = ({ className, color = "currentColor" }) => (
  <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M50 100C20 100 20 150 50 150C80 150 100 100 150 100C180 100 180 50 150 50C120 50 100 100 50 100Z" stroke={color} strokeWidth="8" strokeLinecap="round"/>
  </svg>
);
